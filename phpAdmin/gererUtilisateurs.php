...
<?php
	...
	foreach ($tUtilisateurs as $util) {
		...
		echo "<tr><td>$util->nom</td><td>$util->prenom</td><td>$util->login</td><td>$nomsStock</td><td><a href=\"modifierUtilisateur.php?login=$util->login\">Modifier</a></td><td><a href=\"javascript:alert('Fonction non implémentée');\">Supprimer</a></td></tr>";
	}
?>
</table>
<br><br><br><br>
