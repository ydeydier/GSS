...
<?php
	...
	foreach ($stock->tLigneStock as $ligneStock) {
		...
		echo "<tr><td>$idArticle</td><td><input type='text' name='NOM_$idArticle' value='$nom'></td><td><input type='text' size='7' name='PRIX_$idArticle' value='$article->prix'></td><td><input type='text' size='5' name='QUANTITEREELLE_$idArticle' value='$ligneStock->quantiteReelle'></td></tr>";
	}
	for ($i=1;$i<=5;$i++) {
