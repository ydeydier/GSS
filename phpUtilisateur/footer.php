...
<td class="tdDroiteStock" align="center" valign="top">
	...
	<?php
		...
		foreach ($stock->tLigneStock as $ligneStock) {
			...
			echo "<tr><td>$article->nom</td><td class=\"tdPrix\">$article->prixCourant</td><td class=\"tdQuantite\">$ligneStock->quantiteReelle</td><td class=\"tdQuantiteVirtuelle\">$ligneStock->quantiteVirtuelle</td></tr>";
		}
	?>
	</table>
</td>
